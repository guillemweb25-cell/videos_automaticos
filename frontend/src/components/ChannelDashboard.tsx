        ...
        {activeTab === 'overview' && (
          <div>
            ...
            <div className="glass-panel">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginTop: '20px' }}>
                <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', padding: '20px', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
                  <h4 style={{ marginBottom: '12px', fontSize: '1rem' }}>Vincular YouTube (Manual)</h4>
                  ...
                  <input 
                    ...
                    style={{ width: '100%', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border-color)', borderRadius: '8px', padding: '10px', color: 'white' }}
                  />
                </div>

                <div style={{ backgroundColor: 'rgba(37, 99, 235, 0.05)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(37, 99, 235, 0.2)' }}>
                  <h4 style={{ marginBottom: '12px', fontSize: '1rem', color: '#60a5fa' }}>Vincular YouTube (Fácil)</h4>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div>
                      <p style={{ color: '#94a3b8', fontSize: '0.75rem', marginBottom: '8px' }}>1. Selecciona tu archivo <b>client_secret.json</b>:</p>
                      <input 
                        type="file" 
                        accept=".json" 
                    ...
                    <div style={{ paddingTop: '16px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                      <p style={{ color: '#94a3b8', fontSize: '0.75rem', marginBottom: '12px' }}>2. Una vez subido, autoriza la cuenta:</p>
                      <button
                      ...
                      >
                        <svg viewBox="0 0 24 24" width="18" height="18" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-1 .67-2.28 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.66l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/><path d="M1 1h22v22H1z" fill="none"/></svg>
                        Vincular con Google
                      </button>
                    </div>
                  </div>
